...
log using "cd20210211weekc", text replace
...
bysort Rw6 ID_SEX gap: egen m6Dcd      = mean(Dcd)              if age_group>=4
bysort Rw6 ID_SEX gap: egen m6Dpsy     = mean(Dpsy)             if age_group>=4
bysort Rw6 ID_SEX gap: egen m6cd_`year1' = mean(cd_`year1')          if age_group>=4
bysort Rw6 ID_SEX gap: egen m6cd_`year2' = mean(cd_`year2')          if age_group>=4
bysort Rw6 ID_SEX gap: egen m6psy_`year1'= mean(cd_`year1'_spirit)   if age_group>=4
bysort Rw6 ID_SEX gap: egen m6psy_`year2'= mean(cd_`year2'_spirit)   if age_group>=4
		
bysort Rw6 ID_SEX gap: gen  Rw6n       = _n
										   

bysort Rw3 ID_SEX gap: egen m3Dcd      = mean(Dcd)              if age_group>=4
bysort Rw3 ID_SEX gap: egen m3Dpsy     = mean(Dpsy)             if age_group>=4
bysort Rw3 ID_SEX gap: egen m3cd_`year1' = mean(cd_`year1')          if age_group>=4
bysort Rw3 ID_SEX gap: egen m3cd_`year2' = mean(cd_`year2')          if age_group>=4
bysort Rw3 ID_SEX gap: egen m3psy_`year1'= mean(cd_`year1'_spirit)   if age_group>=4
bysort Rw3 ID_SEX gap: egen m3psy_`year2'= mean(cd_`year2'_spirit)   if age_group>=4
